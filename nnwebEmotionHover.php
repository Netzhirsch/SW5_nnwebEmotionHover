...
class nnwebEmotionHover extends Plugin {
	private $pluginname = 'nnwebEmotionHover';
	...
	public function update(UpdateContext $context) {
		...
		$element = $emotionComponentInstaller->createOrUpdate($this->getName(), "Hover-Banner", [
			'name' => 'Hover-Banner',
			'template' => 'component_nnweb_emotion_hover',
			'xtype' => 'emotion-components-nnweb-emotion-hover',
			'cls' => 'nnweb-emotion-hover'
		]);
		...
		if (version_compare($context->getCurrentVersion(), "1.0.0", "==")) {
			...
			$element->createComboBoxField([
				...
				'allowBlank' => false,
				'store' => 'Shopware.apps.nnwebEmotionHover.store.LinkElementStore',
				'queryMode' => 'local',
				'displayField' => 'name',
				'valueField' => 'value',
				'defaultValue' => 'button',
		...
		if (version_compare($context->getCurrentVersion(), "1.2.4", "<=")) {
			
			$sql = "UPDATE s_library_component_field SET value_field='path' WHERE name = '" . $this->pluginname . "_hintergrundbild" . "'";
	...
	private function registerEmotionElement() {
		...
		$element->createComboBoxField([
			...
			'allowBlank' => false,
			'store' => 'Shopware.apps.nnwebEmotionHover.store.HintergrundPositionStore',
			'queryMode' => 'local',
			'displayField' => 'name',
			'valueField' => 'value',
		...
		$element->createComboBoxField([
			...
			'allowBlank' => false,
			'store' => 'Shopware.apps.nnwebEmotionHover.store.HeadlineTagStore',
			'queryMode' => 'local',
			'displayField' => 'name',
			'valueField' => 'value',
			'defaultValue' => 'h2'
		...
		$element->createComboBoxField([
			...
			'allowBlank' => false,
			'store' => 'Shopware.apps.nnwebEmotionHover.store.LinkTargetStore',
			'queryMode' => 'local',
			'displayField' => 'name',
			'valueField' => 'value',
			'defaultValue' => '_self'
	...
	public function onPostDispatchBackendEmotion(\Enlight_Controller_ActionEventArgs $args) {
		...
		$view->extendsTemplate('backend/emotion/nnweb_emotion_hover/view/detail/elements/nnweb_emotion_hover.js');
		$view->extendsTemplate('backend/emotion/nnweb_emotion_hover/nnweb_emotion_hover_store.js');
	}
}